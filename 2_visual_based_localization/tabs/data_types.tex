...
\begin{table}
	...
	\begin{tabular}{|c | M{0.18\textwidth} | M{0.18\textwidth} | M{0.18\textwidth} | M{0.18\textwidth} |}
		\hline
		\diagbox[width=0.20\textwidth, height=2\line]{Query}{Database} 		& Images collection \S\ref{subsec:visual_info} & Weak geometry \S\ref{subsubsec:weak_geometry}	& SfM \S\ref{subsec:sfm_methods} & 3D model \S\ref{subsubsec:3d_geometry} \\
        \hline
