\begin{figure}[t]
	...
	\subfigure[][Indirect method]{\label{fig:indirect}\includegraphics[width=0.5\linewidth]{methods/indirect.png}}
	\subfigure[][Direct method]{\label{fig:direct}\includegraphics[width=0.48\linewidth]{methods/direct2.png}}
