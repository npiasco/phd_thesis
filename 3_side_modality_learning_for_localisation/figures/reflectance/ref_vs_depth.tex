...
%		\center \scriptsize
%		\includegraphics[width=\linewidth]{plot/depth_vs_ref/Results_night_queries/distance}	
%		
%		\includegraphics[width=\linewidth]{plot/depth_vs_ref/Results_night_queries/recall}
%		
%		c) Oxford -- Night
%	\end{minipage}
	\begin{minipage}{0.19\linewidth}
	...
	%\includegraphics[trim={108 160 205 335},clip,width=0.2\linewidth]{plot/fig/legend_night_corr}\hspace{0.1cm}
	%\includegraphics[trim={108 60 205 430},clip,width=0.2\linewidth]{plot/fig/legend_night_corr}
