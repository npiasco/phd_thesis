...
%% Second university
  ...
  \secondlogolab{\includegraphics[width=2cm]{logos/IGN_log_Q}}

  \seconduni{\href{https://www.udg.edu/}{Universit\'e Paris-Est}}
  \secondlogouni{\includegraphics[width=2cm]{logos/univ-paris-est.png}}
...
%% Second university
  ...
  \seconduni{\href{https://www.udg.edu/}{Universit\'e Paris-Est}}
  \secondlogouni{\includegraphics[width=4cm]{logos/univ-paris-est.png}}
...
\subfile{1_introduction/chapter_1}	% background information + intro
\subfile{2_visual_based_localization/chapter_2} % SOTA
\subfile{3_side_modality_learning_for_localisation/chapter_3} % CBIR VLB method
\subfile{4_pose_refinement/chapter_4} % Relative Pose refinement
\subfile{5_conclusion/chapter_5} %  Conclusion + perspectives
...
\backmatter
\subfile{6_backmatter/appendix/appendix} %  Conclusion + perspectives
