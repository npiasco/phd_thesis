...
\include{1_introduction/chapter_1}	% background information
\include{2_visual_based_localization/chapter_2}
\include{3_side_modality_learning_for_localisation/chapter_3}
\include{4_pose_refinement/chapter_4}
\include{5_conclusion/chapter_5}
