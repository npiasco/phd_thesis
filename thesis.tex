...
\subfile{2_visual_based_localization/chapter_2}
\subfile{3_side_modality_learning_for_localisation/chapter_3}
\subfile{4_pose_refinement/chapter_4}
\subfile{5_conclusion/chapter_5}
